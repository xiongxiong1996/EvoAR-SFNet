...
# /opt/data/private/shaohua/RemoteDetection/EvoARFD/workdir/EvoARFDSFNetL1/checkpoint_240_2025-07-27-03-24-23.pth
def main():
    # 创建参数解析器
    ...
    parser.add_argument('--ckpath', type=str, required=True, help='Path to the checkpoint file')
        # 添加其他路径参数，设置默认值
    parser.add_argument('--test_data_path', type=str, default=r'pansharpening/test_data/WV3/test_wv3_multiExm1.h5', 
                        help='Path to the test data file')
    parser.add_argument('--save_dir', type=str, default=r'2_DL_Result/PanCollection/WV3_Reduced/728/results/',
    ...
    print(f"pan[i].shape: {pan[1].shape}, lms[i].shape: {lms[1].shape}")
