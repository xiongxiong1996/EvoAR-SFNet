...
def main():
    parser = argparse.ArgumentParser(
        description="Export full-resolution pansharpening outputs to .mat files."
    )
    ...
    parser.add_argument(
        ...
        help="Path to the full-resolution test data file.",
    )
    parser.add_argument(
        "--save_dir",
        type=str,
        default="2_DL_Result/PanCollection/WV3_Full/EvoARFS/results/",
    ...
    print(f"Exporting full-resolution results from: {args.test_data_path}")
